...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { name: "Overview", path: "/admin", icon: <LayoutDashboard className="w-4 h-4" />, roles: ["FOUNDER", "ADMIN"], shortcut: "⌥O" },
    { name: "Sales Orders", path: "/admin/orders", icon: <ShoppingCart className="w-4 h-4" />, roles: ["FOUNDER", "ADMIN", "SALES", "ACCOUNTS"], shortcut: "⌥S" },
    { name: "B2B Buyers", path: "/admin/buyers", icon: <Users className="w-4 h-4" />, roles: ["FOUNDER", "ADMIN", "SALES"], shortcut: "⌥B" },
    { name: "Stock & SKU", path: "/admin/stock", icon: <Package className="w-4 h-4" />, roles: ["FOUNDER", "ADMIN", "INVENTORY"], shortcut: "⌥P" },
    { name: "Leads Board", path: "/admin/leads", icon: <Layers className="w-4 h-4" />, roles: ["FOUNDER", "ADMIN", "SALES"], shortcut: "⌥L" },
    { name: "Cash Ledger", path: "/admin/cashflow", icon: <CircleDollarSign className="w-4 h-4" />, roles: ["FOUNDER", "ADMIN", "ACCOUNTS"], shortcut: "⌥C" },
    { name: "WhatsApp Sandbox", path: "/admin/whatsapp", icon: <MessageSquare className="w-4 h-4" />, roles: ["FOUNDER", "ADMIN", "SALES"], shortcut: "⌥W" }
  ];

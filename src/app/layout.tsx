  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="antialiased flex flex-col min-h-screen text-slate-100 bg-slate-950">
        ...
        <header className="sticky top-0 z-40 bg-slate-950/70 backdrop-blur-md border-b border-gold/10 px-4 md:px-8 py-3.5 flex items-center justify-between">
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-slate-500 font-medium">Surat Trends, Mumbai Discipline</span>
          </div>
          ...
          <nav className="flex items-center gap-4 md:gap-7 text-sm font-medium">
            ...
            <Link href="/register" className="py-1 px-3 rounded-lg border border-gold/30 hover:border-gold hover:bg-gold/5 transition-all text-[13px] text-gold">
              Register B2B
            </Link>
